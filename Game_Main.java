...
class statisticsBtnAL implements ActionListener {
	...
	@Override
	public void actionPerformed(ActionEvent e) {
		new Statistics_Frame(main, name, main.allmoney, main.curmoney, main.level, Integer.parseInt(main.tabMoney.getText().substring(0, main.tabMoney.getText().indexOf("원"))), main.automoney,
