...
public class Statistics_Frame extends JFrame {
	...
	public Statistics_Frame(Game_Main main, String name, int allmoney, int curmoney, int lv, int tm, int am, int[] flv,
		...
		uil.setOpaque(false);
		uil.setFont(new Font("HY견고딕", Font.PLAIN, 12));
